...
export const metadata = {
  title: "Sign In to Yumy | Discover and Share Delicious Recipes",
  description: "Access your Yumy account to explore new recipes, share your own creations, and connect with other food enthusiasts.",
};
